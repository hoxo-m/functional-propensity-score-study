...
reimplemented, and its main results have been reproduced.

- [Reproduction of Table 1](Table1.md) — simulation setup,
  implementation, and reproduced results.
- [Notes on the derivation of the SFPS weights](SFPSDerivationNotes.md)
...
reproducibility. The reproduced results differ slightly from those
reported in the original paper because this implementation was developed
independently and differs in some preprocessing, FPCA, and numerical
